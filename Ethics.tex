...
\abstract{In many modern games micro transactions have started to appear allowing users to get additional in-game content with real world money or by exchanging real world money for premium currency. Although a newer perhaps more predatory form of these micro transactions has emerged. Loot boxes as gambling is an issue that has recently become very popular amongst consumers and many would claim that loot boxes are a form of gambling and that because they are unregulated can be used to target people who are susceptible to gambling or have addictive tendencies.}
